...
$page_name = 'Stage paysage marin';
$description = 'Stage photo de paysage marin en Normandie. Apprendre à photographier la mer, les falaises et les plages. En s\'adaptant aux conditions météorologiques et en jouant avec les éléments naturels.';

$image = '/assets/images/topics/seascape.jpg';
$alt_image = 'Pontons sur la plage de Luc-sur-Mer, en Normandie.';
$topic = 'Paysage marin';
$title = 'La richesse du bord de mer';
$paragraph = 'Composer une image, régler son appareil en fonction de la situation, gérer l\'horizon et les éléments présents, sont autant de sujets à aborder ! <br>
            <br> 
