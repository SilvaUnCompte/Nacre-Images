...
if (!isset($_POST['title']) || !isset($_POST['info']) || !isset($_POST['start_date']) || !isset($_POST['end_date']) || !isset($_POST['visible']) || !isset($_POST['img'])) {
...
News::create($title, $info, $start_date, $end_date, $visible, $img);
